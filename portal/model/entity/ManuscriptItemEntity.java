...
@MappedSuperclass
public class ManuscriptItemEntity extends EntityBase<com.dxn.model.extend.ManuscriptItem> {
    ...
    @JsonIgnore
    public static com.dxn.model.extend.ManuscriptItem findById(Long id) throws Exception {
        return repository().findById(id, com.dxn.model.extend.ManuscriptItem.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.ManuscriptItem findById(Long id, String timestamp) throws Exception {
        return repository().findById(id, timestamp, com.dxn.model.extend.ManuscriptItem.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.ManuscriptItem findByIdReadOnly(Long id) throws Exception {
        return repository().findByIdReadOnly(id, com.dxn.model.extend.ManuscriptItem.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.ManuscriptItem findByIdReadOnly(Long id, String timestamp) throws Exception {
        return repository().findByIdReadOnly(id, timestamp, com.dxn.model.extend.ManuscriptItem.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.ManuscriptItem createNew() throws Exception {
        com.dxn.model.extend.ManuscriptItem entity = new com.dxn.model.extend.ManuscriptItem();
    ...
    @JsonIgnore
    public static JPAJinqStream<com.dxn.model.extend.ManuscriptItem> stream() throws Exception {
        return repository().stream(com.dxn.model.extend.ManuscriptItem.class);
    }
