...
@MappedSuperclass
public class BusinessSub14Entity extends EntityBase<com.dxn.model.extend.BusinessSub14> {
    ...
    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub14 findById(Long id) throws Exception {
        return repository().findById(id, com.dxn.model.extend.BusinessSub14.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub14 findById(Long id, String timestamp) throws Exception {
        return repository().findById(id, timestamp, com.dxn.model.extend.BusinessSub14.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub14 findByIdReadOnly(Long id) throws Exception {
        return repository().findByIdReadOnly(id, com.dxn.model.extend.BusinessSub14.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub14 findByIdReadOnly(Long id, String timestamp) throws Exception {
        return repository().findByIdReadOnly(id, timestamp, com.dxn.model.extend.BusinessSub14.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub14 createNew() throws Exception {
        com.dxn.model.extend.BusinessSub14 entity = new com.dxn.model.extend.BusinessSub14();
    ...
    @JsonIgnore
    public static JPAJinqStream<com.dxn.model.extend.BusinessSub14> stream() throws Exception {
        return repository().stream(com.dxn.model.extend.BusinessSub14.class);
    }
