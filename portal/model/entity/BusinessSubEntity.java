...
@MappedSuperclass
public class BusinessSubEntity extends EntityBase<com.dxn.model.extend.BusinessSub> {
    ...
    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub findById(Long id) throws Exception {
        return repository().findById(id, com.dxn.model.extend.BusinessSub.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub findById(Long id, String timestamp) throws Exception {
        return repository().findById(id, timestamp, com.dxn.model.extend.BusinessSub.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub findByIdReadOnly(Long id) throws Exception {
        return repository().findByIdReadOnly(id, com.dxn.model.extend.BusinessSub.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub findByIdReadOnly(Long id, String timestamp) throws Exception {
        return repository().findByIdReadOnly(id, timestamp, com.dxn.model.extend.BusinessSub.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub createNew() throws Exception {
        com.dxn.model.extend.BusinessSub entity = new com.dxn.model.extend.BusinessSub();
    ...
    @JsonIgnore
    public static JPAJinqStream<com.dxn.model.extend.BusinessSub> stream() throws Exception {
        return repository().stream(com.dxn.model.extend.BusinessSub.class);
    }
