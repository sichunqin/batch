...
@MappedSuperclass
public class BusinessSub12Entity extends EntityBase<com.dxn.model.extend.BusinessSub12> {
    ...
    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub12 findById(Long id) throws Exception {
        return repository().findById(id, com.dxn.model.extend.BusinessSub12.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub12 findById(Long id, String timestamp) throws Exception {
        return repository().findById(id, timestamp, com.dxn.model.extend.BusinessSub12.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub12 findByIdReadOnly(Long id) throws Exception {
        return repository().findByIdReadOnly(id, com.dxn.model.extend.BusinessSub12.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub12 findByIdReadOnly(Long id, String timestamp) throws Exception {
        return repository().findByIdReadOnly(id, timestamp, com.dxn.model.extend.BusinessSub12.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub12 createNew() throws Exception {
        com.dxn.model.extend.BusinessSub12 entity = new com.dxn.model.extend.BusinessSub12();
    ...
    @JsonIgnore
    public static JPAJinqStream<com.dxn.model.extend.BusinessSub12> stream() throws Exception {
        return repository().stream(com.dxn.model.extend.BusinessSub12.class);
    }
