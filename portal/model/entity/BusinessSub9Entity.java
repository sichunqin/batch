...
@MappedSuperclass
public class BusinessSub9Entity extends EntityBase<com.dxn.model.extend.BusinessSub9> {
    ...
    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub9 findById(Long id) throws Exception {
        return repository().findById(id, com.dxn.model.extend.BusinessSub9.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub9 findById(Long id, String timestamp) throws Exception {
        return repository().findById(id, timestamp, com.dxn.model.extend.BusinessSub9.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub9 findByIdReadOnly(Long id) throws Exception {
        return repository().findByIdReadOnly(id, com.dxn.model.extend.BusinessSub9.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub9 findByIdReadOnly(Long id, String timestamp) throws Exception {
        return repository().findByIdReadOnly(id, timestamp, com.dxn.model.extend.BusinessSub9.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub9 createNew() throws Exception {
        com.dxn.model.extend.BusinessSub9 entity = new com.dxn.model.extend.BusinessSub9();
    ...
    @JsonIgnore
    public static JPAJinqStream<com.dxn.model.extend.BusinessSub9> stream() throws Exception {
        return repository().stream(com.dxn.model.extend.BusinessSub9.class);
    }
