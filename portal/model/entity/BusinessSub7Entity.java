...
@MappedSuperclass
public class BusinessSub7Entity extends EntityBase<com.dxn.model.extend.BusinessSub7> {
    ...
    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub7 findById(Long id) throws Exception {
        return repository().findById(id, com.dxn.model.extend.BusinessSub7.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub7 findById(Long id, String timestamp) throws Exception {
        return repository().findById(id, timestamp, com.dxn.model.extend.BusinessSub7.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub7 findByIdReadOnly(Long id) throws Exception {
        return repository().findByIdReadOnly(id, com.dxn.model.extend.BusinessSub7.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub7 findByIdReadOnly(Long id, String timestamp) throws Exception {
        return repository().findByIdReadOnly(id, timestamp, com.dxn.model.extend.BusinessSub7.class);
    }

    @JsonIgnore
    public static com.dxn.model.extend.BusinessSub7 createNew() throws Exception {
        com.dxn.model.extend.BusinessSub7 entity = new com.dxn.model.extend.BusinessSub7();
    ...
    @JsonIgnore
    public static JPAJinqStream<com.dxn.model.extend.BusinessSub7> stream() throws Exception {
        return repository().stream(com.dxn.model.extend.BusinessSub7.class);
    }
