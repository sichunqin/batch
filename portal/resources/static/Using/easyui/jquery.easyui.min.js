        ...
        function _405() {
            ...
            if (_400 == "east" && _401.expandEast) {
                ...
                if (_400 == "west" && _401.expandWest) {
                    return {
                        collapse: {left: -p.panel("panel")._outerWidth(), top: _406.top, height: _406.height},
                        expand: {left: 0}
                    };
                } else {
    ...
    function _486(_487, _488, data) {
        ...
        $(_488).tooltip({
            ...
            onUpdate: function (_489) {
                ...
                var data = _48a.data;
                _489.accordion({width: opts.floatMenuWidth, multiple: false}).accordion("add", {
                    title: data.text,
                    collapsed: false,
                    collapsible: false
                });
...
(function ($) {
    ...
    function _73b(_73c) {
        ...
        function _741(_746, _747, _748) {
            ...
            if (_748 && opts.rownumbers) {
                var td = $("<td rowspan=\"" + opts.frozenColumns.length + "\"><div class=\"datagrid-header-rownumber\"><span class=\"search-btn-icon icon-search_b\"></span></div></td>");
                if ($("tr", t).length == 0) {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        rownumberWidth: 30,
        editorHeight: 31,
        headerEvents: {mouseover: _75c(true), mouseout: _75c(false), click: _760, dblclick: _765, contextmenu: _768},
        rowEvents: {mouseover: _76a(true), mouseout: _76a(false), click: _771, dblclick: _77b, contextmenu: _77f},
