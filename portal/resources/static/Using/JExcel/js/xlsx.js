            ...
            while (i < fmt.length) {
                switch ((c = fmt.charAt(i))) {
                    ...
                    case ' ':
                        ...
                        break;
                    default:
                        if (",$-+/():!^&'~{}<>=鈧琣cfijklopqrtuvwxzP".indexOf(c) === -1) throw new Error('unrecognized character ' + c + ' in ' + fmt);
...
//function char2width_(chr) { return (((chr * MDW + 5)/MDW*256))/256; }
    ...
    function write_theme(Themes, opts) {
        ...
        o[o.length] = '<a:font script="Jpan" typeface="锛汲 锛般偞銈枫儍銈�"/>';
        o[o.length] = '<a:font script="Hang" typeface="毵戩潃 瓿犽敃"/>';
        o[o.length] = '<a:font script="Hans" typeface="瀹嬩綋"/>';
        o[o.length] = '<a:font script="Hant" typeface="鏂扮窗鏄庨珨"/>';
            ...
            while ((Rn = xlmlregex.exec(str))) switch ((Rn[3] = Rn[3].replace(/_.*$/, ""))) {
                ...
                case '宸ヤ綔琛�': // 9.1.2 <table:table>
                    if (Rn[1] === '/') {
                        ...
                        if (merges.length) ws['!merges'] = merges;
                        if (rowinfo.length) ws["!rows"] = rowinfo;
                        sheetag.name = sheetag['鍚嶇О'] || sheetag.name;
                ...
                case '琛�': // 9.1.3 <table:table-row>
                    ...
                    if (rowtag['琛屽彿']) R = rowtag['琛屽彿'] - 1; else if (R == -1) R = 0;
                ...
                case '鏁版嵁':
                    if (Rn[0].charAt(Rn[0].length - 2) === '/') {
                        ...
                        if ((ctag['鏁版嵁绫诲瀷'] || ctag['value-type']) == "string") {
                            q.t = "s";
                        ...
                        comments = [];
                        comment = ({});
                        q = ({t: ctag['鏁版嵁绫诲瀷'] || ctag['value-type'], v: null});
                        if (opts.cellFormula) {
                ...
                case '鐢靛瓙琛ㄦ牸鏂囨。': // 3.1.3.2 <office:document-content>
                case 'spreadsheet':
                case '涓讳綋': // 3.7 <office:spreadsheet>
                ...
                /* ignore state */
                case 'meta':
                case '鍏冩暟鎹�': // TODO: <office:meta> <uof:鍏冩暟鎹�> FODS/UOF
