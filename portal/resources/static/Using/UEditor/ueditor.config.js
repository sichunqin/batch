...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //服务器统一请求接口路径
        serverUrl: "/ueditorServlet",

        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的重新定义
        toolbars: [[
            'fullscreen'/*全屏*/, 'source'/*源代码*/, '|', 'undo'/*撤销*/, 'redo'/*重做*/, '|',
            ...
            'insertimage'/*多图上传*/, 'emotion'/*表情*/, 'scrawl'/*涂鸦*/, 'insertvideo'/*视频*/, 'music'/*音乐*/,
            'attachment'/*附件*/, 'map'/*Baidu地图*/, 'gmap'/*Google地图*/, 'insertframe'/*插入Iframe*/,
            'insertcode'/*代码语言*/, 'webapp'/*百度应用*/, 'pagebreak'/*分页*/, 'template'/*模板*/, 'background'/*背景*/, '|',
